namespace Bez
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.pictureBox1.Size = new System.Drawing.Size(547, 512);
			...
			this.button3.Text = "Delete Point";
			this.button3.UseVisualStyleBackColor = true;
			this.button3.Click += new System.EventHandler(this.delete_Click);
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(598, 447);
			this.button4.Name = "button4";
			this.button4.Size = new System.Drawing.Size(112, 34);
			this.button4.TabIndex = 5;
			this.button4.Text = "Draw";
			this.button4.UseVisualStyleBackColor = true;
			this.button4.Click += new System.EventHandler(this.draw_Click);
			// 
			// button5
			// 
			...
			this.button5.Text = "Cleare";
			this.button5.UseVisualStyleBackColor = true;
			this.button5.Click += new System.EventHandler(this.cleare_Click);
			// 
			// Form1
			// 
